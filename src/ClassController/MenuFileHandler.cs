namespace ClassController
{
    ...
    /// <summary>
    /// Class in charge of handling menu data operations by files.
    /// </summary>
    public class MenuFileHandler : IDataHandler<Menu>
    {
        private readonly string filePath;

        /// <summary>
        /// Initializes a new instance of the <see cref="MenuFileHandler"/> class.
        /// </summary>
        /// <param name="filePath">The file path.</param>
        public MenuFileHandler(string filePath)
        {
